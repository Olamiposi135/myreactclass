...
const [isSetNav, setNavBar] = useState (false)
...
let loginName = "Olamipo"

  return (
    <>
    <nav className = "flex justify-between items-center py-4 px-8 max-w-[1400px] m-auto">
      ...
      <li className="flex items-center hover:text-[#00a2ff] cursor-pointer"> Pricing</li>
      <li className="flex items-center gap-1 hover:text-[#00a2ff] cursor-pointer">
        Resources 
        <IoIosArrowForward className="text-xs mt-1"/>
        </li>
      <li className="flex items-center hover:text-[#00a2ff] cursor-pointer">Book a demo</li>
    </ul>
       </div>

       <div className="flex lg:hidden text-2xl z-10 cursor-pointer">
       
       {isSetNav? <RiCloseLargeLine onClick={Toggle} /> :
    ...
    {isSetNav &&
      <nav className=" lg:hidden pt-14 pl-5 absolute top-0 right-0 h-screen w-[70%] bg-white space-y-4">
        <ul className = "  space-y-4 font-bold text-2xl ">
          <li className=" hover:text-[#00a2ff] cursor-pointer">
            Product 
