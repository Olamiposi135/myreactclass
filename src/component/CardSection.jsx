...
export default function CardSection() {
  return (
    <section className="h-screen flex flex-col  max-w-[1140px] m-auto  p-13 mb-12 ">

      <h1 className="text-center mb-10 font-bold text-[35px]">Why GetResponse?</h1>
      
      <div className="flex  justify-around items-center w-[90%] m-auto gap-14 mb-10">
      ...
      <div className="flex gap-5 mb-4 ">
        <div className="flex-1 cursor-pointer p-8  rounded-xl border-4 shadow-xl border-transparent hover:border-[#00a2ff]  transition-all duration-300 ease-in-out">
          ...
          <button className="py-3 px-8 bg-[#38a2ff] text-lg text-white rounded-3xl font-bold border-2 border-[#3393f2] hover:bg-[#fbe30c] hover:text-black hover:border-[#e3d500]  transition-all duration-300 ease-in-out">
