    ...
    <section className="h-screen flex flex-col justify-center items-center max-w-[1400px] m-auto px-4 mt-10 lg:mt-0">
      <div className="text-center space-y-7 w-[90%] m-auto">
        ...
        <p className="lg:text-black text-lime-700 text-[18px] max-w-[800px] m-auto">
          ...
          that brings email, automation, online courses and paid newsletters
          together.
        </p>

        <button
          onClick={subscribe}
          className="text-lg lg:text-xl font-bold px-6 lg:px-10 py-4 rounded-3xl w-fit border-2 border-[#e3d500] bg-[#fbe30c] hover:bg-[#00a2ff] hover:text-white hover:border-[#2c85d5] whitespace-nowrap"
        >
          {" "}
          {isSubscribe ? "You are now Subcribed" : "Start 30-days Free trial"}
